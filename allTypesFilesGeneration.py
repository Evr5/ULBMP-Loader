...
for j in range(240):
    for i in range(750*1):
        pixel2.append(Pixel(j, j, j))
image4 = Image(750, 1040, pixel2)
...
Encoder(image5, 3, depth = 24, rle = False).save_to(download_folder+'v3_depth24_rle=False.ulbmp')
Encoder(image5, 3, depth = 24, rle = True).save_to(download_folder+'v3_depth24_rle=True.ulbmp')
